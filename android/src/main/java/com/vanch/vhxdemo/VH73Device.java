...
public class VH73Device {
	...
	private static byte[] getDataSegment(byte[] data) {
        ...
        Log.e("OGTAGDEBUG::","data segment is " + Utility.bytes2HexString(dataSegment));
        return dataSegment;
	}
	...
	public byte[] getCmdResult() throws IOException {
		...
		Log.e("OGTAGDEBUG::", "getCmdResult: " +  Utility.bytes2HexString(bb.array()));
	...
	public static ListTagIDResult parseListTagIDResult(byte[] ret) {
		byte[] data = getDataSegment(ret);
        Log.e("OGTAGDEBUG::", "parseListTagIDResult: " + data );
		...
		Log.e("OGTAGDEBUG::", "XXXXXXXX::: parseListTagIDResult: " + epcs.size() );
        if(index < len) {
            for (int i = 0; i < len; i++) {
                int ecpLen = data[index];
                byte[] epc = new byte[ecpLen * 2];
                ...
                epcs.add(epc);
                index = index + (ecpLen * 2) + 1;
                Log.e("OGTAGDEBUG::", "XXXXXXXX::: parseListTagIDResult: " +  Utility.bytes2HexString(epc) + " " + index
                        + " " + ecpLen);
